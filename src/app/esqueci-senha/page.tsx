...
export default function EsqueciSenha() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Implementar lógica de esqueci senha aqui
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-1/2 bg-white p-12 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          <h2 className="text-4xl font-bold mb-2 text-center text-black">Recuperar senha</h2>
          <p className="text-gray-400 mb-8 text-center">Preencha seu email para recuperar sua senha</p>
